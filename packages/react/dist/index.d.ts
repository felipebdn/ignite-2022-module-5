...
declare const Root: _stitches_react_types_styled_component.StyledComponent<react.ForwardRefExoticComponent<Toast$1.ToastProps & react.RefAttributes<HTMLLIElement>>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
interface ToastProps extends ComponentProps<typeof Root> {
    title: string;
    date: string;
}
declare function Toast({ date, title, ...props }: ToastProps): JSX.Element;

declare const Content: _stitches_react_types_styled_component.StyledComponent<react.ForwardRefExoticComponent<Tooltip$1.TooltipContentProps & react.RefAttributes<HTMLDivElement>>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
interface TooltipProps extends ComponentProps<typeof Content> {
    content: string;
}
declare function Tooltip({ content, ...props }: TooltipProps): JSX.Element;
